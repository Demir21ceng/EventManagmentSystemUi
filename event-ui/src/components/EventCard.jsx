...
const EventCard = ({ event }) => {
    ...
    // ORGANIZER "Bilet Al" butonunu görmez
    // Login olmayan kullanıcı görebilir ama BuyTicketModal içinde login zorunlu tutulacak
    const isOrganizer = authService.isOrganizer();
    const canBuy = event.eventStatus === "PUBLISHED" && !isOrganizer;
