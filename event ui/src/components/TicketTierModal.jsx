...
const TicketTierModal = ({ open, onClose, event }) => {
    ...
    const handleAdd = async () => {
        if (!form.name || !form.price || !form.totalQuantity || !form.saleStartDate || !form.saleEndDate) {
        ...
        try {
            const payload = {
                ...
                saleStartDate: form.saleStartDate + ":00", // LocalDateTime formatı
            ...
            <DialogContent>
                ...
                <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 2, mb: 2 }}>
                    <TextField
                        label="Bilet Adı"
                        name="name"
                        placeholder="VIP, Normal, Early Bird..."
                        value={form.name}
